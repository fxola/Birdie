...
import { checks, generateResponse } from '../helper/events';
...
eventsController.get(
  '/api/events/:recipient/wellbeing',
  async (req, res, next) => {
...
eventsController.get(
  '/api/events/:recipient/metabolism',
  async (req, res, next) => {
...
eventsController.get(
  '/api/events/:recipient/medication',
  async (req, res, next) => {
...
eventsController.get('/api/events/:recipient/alert', async (req, res, next) => {
